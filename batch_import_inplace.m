...
candidates_specific= ImportCandidates(reader, char(candidates.getContainers.get(j-1).getFile), handler);
success = library.importCandidates(config, candidates_specific);t11=toc;
