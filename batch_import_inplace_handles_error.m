...
username = 'tester';  %Username for Insight
...
for i=1:length(nameFolds)
    ...
    %Create a project
    tic;project = createProject(session, Projectname);t1=toc;
    ...
    for j=1:datasetno
        ...
        tic;candidates_specific= ImportCandidates(reader, char(candidates.getContainers.get(j-1).getFile), handler);t12=toc;
    ...
    reader.close();store.closeServices();
